...
public abstract class ServoMotorSubsystem extends Subsystem {
    ...
    private final StatusSignal<Double> mMasterPositionSignal;
    private final StatusSignal<Double> mMasterVelocitySignal;
    private final StatusSignal<Double> mMasterClosedLoopError;
    private final StatusSignal<Double> mMasterStatorCurrentSignal;
    private final StatusSignal<Double> mMasterOutputVoltageSignal;
    private final StatusSignal<Double> mMasterOutputPercentageSignal;
    private final StatusSignal<Double> mMasterClosedLoopOutputSignal;
    private final StatusSignal<Double> mMasterClosedLoopReferenceSignal;
    private final StatusSignal<Double> mMasterClosedLoopReferenceSlopeSignal;
    ...
    protected ServoMotorSubsystem(final ServoMotorSubsystemConstants constants) {
        ...
        TalonUtil.checkErrorAndRetry(() -> mMaster.getBridgeOutput().setUpdateFrequency(200, 0.05));
        TalonUtil.checkErrorAndRetry(() -> mMaster.getFault_Hardware().setUpdateFrequency(4, 0.05));
        ...
        TalonUtil.checkErrorAndRetry(() -> mMasterClosedLoopReferenceSignal.setUpdateFrequency(200, 0.05));
        TalonUtil.checkErrorAndRetry(() -> mMasterClosedLoopOutputSignal.setUpdateFrequency(200, 0.05));
        TalonUtil.checkErrorAndRetry(() -> mMasterClosedLoopReferenceSlopeSignal.setUpdateFrequency(200, 0.05));
        ...
        for (int i = 0; i < mSlaves.length; ++i) {
            ...
            TalonUtil.checkErrorAndRetry(() -> slave.getConfigurator().refresh(slaveConfig));
        ...
        // mMotionProfileConstraints = new MotionProfileConstraints(rotationsToUnits(mConstants.kCruiseVelocity), rotationsToUnits(-mConstants.kCruiseVelocity), rotationsToUnits(mConstants.kAcceleration));
        mMotionProfileConstraints = new MotionProfileConstraints(rotationsToUnits(mConstants.kCruiseVelocity), rotationsToUnits(-mConstants.kCruiseVelocity), rotationsToUnits(mConstants.kAcceleration));
    ...
    protected StatusSignal<Integer> mMasterStickyFault;
    ...
    public synchronized void zeroSensors() {
        TalonUtil.checkErrorAndRetry(() -> mMaster.setPosition(0, mConstants.kCANTimeout));
        mHasBeenZeroed = true;
    }
