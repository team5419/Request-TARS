...
public class SwerveModule {
    ...
    private SwerveModuleConstants cachedConstants; //! NOT CTRE CODE
    private String cachedCanbusName; //! NOT CTRE CODE
    ...
    public SwerveModule(SwerveModuleConstants constants, String canbusName, boolean supportsPro) {
        ...
        cachedConstants = constants; //! NOT CTRE CODE
        cachedCanbusName = canbusName; //! NOT CTRE CODE
    }
    ...
    public void apply(SwerveModuleState state, boolean isOpenLoop) {
        ...
        double velocityToSet = (optimized.speedMetersPerSecond * m_driveRotationsPerMeter) - driveRateBackOut;
    ...
    public com.ctre.phoenix6.mechanisms.swerve.SwerveModule toCTREmodule() {
        return new com.ctre.phoenix6.mechanisms.swerve.SwerveModule(cachedConstants, cachedCanbusName , m_supportsPro);
    }
}
