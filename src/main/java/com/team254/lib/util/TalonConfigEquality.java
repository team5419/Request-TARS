...
public class TalonConfigEquality {
    ...
    public static boolean isEqual(OpenLoopRampsConfigs a, OpenLoopRampsConfigs b) {
        boolean val = Util.epsilonEquals(a.DutyCycleOpenLoopRampPeriod, b.DutyCycleOpenLoopRampPeriod,TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(ClosedLoopRampsConfigs a, ClosedLoopRampsConfigs b) {
        boolean val = Util.epsilonEquals(a.DutyCycleClosedLoopRampPeriod, b.DutyCycleClosedLoopRampPeriod,TALON_CONFIG_EPSILON)
                && Util.epsilonEquals(a.VoltageClosedLoopRampPeriod, b.VoltageClosedLoopRampPeriod,TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(HardwareLimitSwitchConfigs a, HardwareLimitSwitchConfigs b) {
        boolean val = a.ForwardLimitAutosetPositionEnable == b.ForwardLimitAutosetPositionEnable
                ...
                && Util.epsilonEquals(a.ForwardLimitAutosetPositionValue, b.ForwardLimitAutosetPositionValue,TALON_CONFIG_EPSILON)
                && Util.epsilonEquals(a.ReverseLimitAutosetPositionValue, b.ReverseLimitAutosetPositionValue,TALON_CONFIG_EPSILON)
